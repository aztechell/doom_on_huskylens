#!/usr/bin/env python3
"""Create a metadata sidecar for DOOM on HuskyLens firmware images."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Prepare a DOOM on HuskyLens firmware image artifact")
